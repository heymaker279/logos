...
# from ..main.tasks import new_order_send_message, new_user_register_send_message, canceled_order_send_mail
...
from ..main.models import Category, ProductInfo, Order, OrderItem, \
    Contact, ConfirmEmailToken, Product, User
